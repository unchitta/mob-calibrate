...
4. Use the following Geography filters:
	4.1. Select Metropolitan/Micropolitan Statistical Area and choose the desired target area
	4.2. Select Block Group -> Within Other Geographies -> Metropolitan/Micropolitan Statistical Area -> choose the corresponding desired target area -> All Block Groups within [selected targret area]
